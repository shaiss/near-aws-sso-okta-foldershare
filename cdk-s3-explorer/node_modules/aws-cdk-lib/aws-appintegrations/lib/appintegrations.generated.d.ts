...
export declare class CfnApplication extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggableV2 {
     ...
     */
    readonly attrId: string;
    applicationConfig?: CfnApplication.ApplicationConfigProperty | cdk.IResolvable;
    /**
     ...
     */
    description: string;
    iframeConfig?: CfnApplication.IframeConfigProperty | cdk.IResolvable;
    /**
     ...
     */
    isService?: boolean | cdk.IResolvable;
    /**
