 ...
 */
export declare class CfnThreatEntitySet extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    readonly attrErrorDetails: string;
    /**
     ...
     * The tags to be added to a new threat entity set resource.
     */
    tags?: Array<CfnThreatEntitySet.TagItemProperty>;
    /**
     * @param scope Scope in which this resource is defined
     * @param id Construct identifier for this resource (unique in its scope)
     * @param props Resource properties
 ...
 */
export declare class CfnTrustedEntitySet extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    tags?: Array<CfnTrustedEntitySet.TagItemProperty>;
    /**
     * @param scope Scope in which this resource is defined
     * @param id Construct identifier for this resource (unique in its scope)
     * @param props Resource properties
