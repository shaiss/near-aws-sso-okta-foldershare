...
export declare class CfnUserPoolClient extends cdk.CfnResource implements cdk.IInspectable {
     ...
     */
    refreshTokenRotation?: cdk.IResolvable | CfnUserPoolClient.RefreshTokenRotationProperty;
    /**
...
export interface CfnUserPoolClientProps {
     ...
     */
    readonly refreshTokenRotation?: cdk.IResolvable | CfnUserPoolClient.RefreshTokenRotationProperty;
    /**
     * The refresh token time limit.
     *
...
export interface CfnUserPoolDomainProps {
     ...
     * A version number that indicates the state of managed login for your domain.
     *
     * Version `1` is hosted UI (classic). Version `2` is the newer managed login with the branding editor. For more information, see [Managed login](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-managed-login.html) .
     *
