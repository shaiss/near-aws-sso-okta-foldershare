...
export declare class CfnFirewall extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggable {
     ...
     */
    availabilityZoneChangeProtection?: boolean | cdk.IResolvable;
    /**
     * The Availability Zones where the firewall endpoints are created for a transit gateway-attached firewall.
     */
    availabilityZoneMappings?: Array<CfnFirewall.AvailabilityZoneMappingProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
...
export interface CfnFirewallProps {
     ...
     */
    readonly availabilityZoneChangeProtection?: boolean | cdk.IResolvable;
    /**
     * The Availability Zones where the firewall endpoints are created for a transit gateway-attached firewall.
     *
     ...
     */
    readonly availabilityZoneMappings?: Array<CfnFirewall.AvailabilityZoneMappingProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * A flag indicating whether it is possible to delete the firewall.
     *
     ...
     */
    readonly enabledAnalysisTypes?: Array<string>;
    /**
     * The descriptive name of the firewall.
     *
...
export declare namespace CfnFirewallPolicy {
    ...
    interface StatefulRuleGroupReferenceProperty {
         ...
         */
        readonly deepThreatInspection?: boolean | cdk.IResolvable;
        /**
...
export declare class CfnLoggingConfiguration extends cdk.CfnResource implements cdk.IInspectable {
    ...
    enableMonitoringDashboard?: boolean | cdk.IResolvable;
    /**
...
export interface CfnLoggingConfigurationProps {
     ...
     */
    readonly enableMonitoringDashboard?: boolean | cdk.IResolvable;
    /**
     * The Amazon Resource Name (ARN) of the firewallthat the logging configuration is associated with.
     *
...
export declare class CfnRuleGroup extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggable {
     ...
     */
    summaryConfiguration?: cdk.IResolvable | CfnRuleGroup.SummaryConfigurationProperty;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
...
export declare namespace CfnRuleGroup {
    ...
    interface SummaryConfigurationProperty {
         ...
         */
        readonly ruleOptions?: Array<string>;
    }
}
/**
...
export interface CfnRuleGroupProps {
     ...
     */
    readonly summaryConfiguration?: cdk.IResolvable | CfnRuleGroup.SummaryConfigurationProperty;
    /**
     * An array of key-value pairs to apply to this resource.
     *
     * For more information, see [Tag](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html) .
 ...
 */
export declare class CfnVpcEndpointAssociation extends cdk.CfnResource implements cdk.IInspectable, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnVpcEndpointAssociation from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnVpcEndpointAssociation;
    /**
     ...
     */
    readonly attrVpcEndpointAssociationArn: string;
    /**
     * The unique identifier of the VPC endpoint association.
     *
     * @cloudformationAttribute VpcEndpointAssociationId
     */
    readonly attrVpcEndpointAssociationId: string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    subnetMapping: cdk.IResolvable | CfnVpcEndpointAssociation.SubnetMappingProperty;
    /**
     * The key:value pairs to associate with the resource.
     */
    tags?: Array<cdk.CfnTag>;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnVpcEndpointAssociationProps);
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnVpcEndpointAssociation {
    /**
     * The ID for a subnet that's used in an association with a firewall.
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkfirewall-vpcendpointassociation.html
 */
export interface CfnVpcEndpointAssociationProps {
    /**
     * A description of the VPC endpoint association.
     *
     ...
     */
    readonly subnetMapping: cdk.IResolvable | CfnVpcEndpointAssociation.SubnetMappingProperty;
    /**
     * The key:value pairs to associate with the resource.
     *
